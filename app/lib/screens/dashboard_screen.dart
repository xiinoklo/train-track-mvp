...
class _DashboardScreenState extends State<DashboardScreen>
  ...
  void _goToSavedRoutines() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => const SavedRoutinesScreen()),
    );
  }
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder<ThemeMode>(
      ...
      builder: (context, mode, _) {
        ...
        final Color pageBottomColor = isDark
            ? const Color(0xFF020617)
            : const Color(0xFFF8FAFC);

        final Color cardColor = isDark ? const Color(0xFF0F172A) : Colors.white;

        final Color cardTextColor = isDark ? Colors.white : darkText;
